...
<nav role="navigation" class="navbar navbar-default real-nav" >
        ...
        <div class="navbar-header">
            ...
            <a href="index.php" class="navbar-brand"><img src='images/hospital-logo.png' class='img-responsive img-logo' style="height: 125px;margin-bottom: 100;margin-top: -70px;"></a>
        </div>
