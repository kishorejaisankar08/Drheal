...
<html>
<head>
	<title>CORONA - <?php echo CONFIG::SYSTEM_NAME; ?></title>
		...
		<div class='row'>
			...
			<div class='col-md-7'>
				...
				<div class='content-header'> 
					Corona <small> contagious diseases</small>
				</div>
				<div class='content-body'> 
					<?php Messages::info("Information of the people living with contagious diseases. This will help hospital"); ?> 
